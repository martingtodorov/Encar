  ...
  faq: doc(
    ...
    [
      ["Цената на сайта крайна ли е?",
        ["Да, освен ако на страницата на обявата не е посочено друго. Показваната цена е крайна прогнозна цена до България.",
      ...
      ["Колко време отнема доставката?",
        ["Между 12 и 14 седмици от потвърдена поръчка. Зависи от корабните разписания, пристанищните операции и митническите процедури.",
      ...
      ["Регистрацията в България включена ли е?",
        ["Не. Цената е крайна прогнозна цена до България. Регистрацията и данъкът върху превозното средство се извършват от теб.",
    ...
    [
      ["Какво включва показаната цена",
        ["Стойността на автомобила в Корея.",
         ...
         "Транспорт от пристанището до България.",
      ...
      ["Плащане",
        ["Депозитът се плаща с карта през Stripe. Остатъкът — по банков път по сметка на Auto&Bid LTD или по сметка на нашия канадски партньор посредник VIN TRADE LLC, според това какво е посочено във фактурата, която получавате.",
  ...
  faq: doc(
    ...
    [
      ["Prețul afișat este final?",
        ["Da, dacă pagina anunțului nu spune altfel. Prețul afișat este prețul final estimat până în Bulgaria.",
      ...
      ["Cât durează livrarea?",
        ["Între 12 și 14 săptămâni de la comanda confirmată, în funcție de orarele navelor, operațiunile portuare și procedurile vamale.",
      ...
      ["Înmatricularea este inclusă?",
        ["Nu. Prețul este prețul final estimat până în Bulgaria. Înmatricularea și impozitul local le faci tu.",
    ...
    [
      ["Ce include prețul afișat",
        ["Valoarea automobilului în Coreea.",
         ...
         "Transportul din port până în Bulgaria.",
      ...
      ["Plata",
        ["Depozitul se plătește cu cardul prin Stripe. Restul — prin transfer bancar în contul Auto&Bid LTD sau în contul partenerului nostru intermediar canadian VIN TRADE LLC, în funcție de ce este indicat pe factura primită.",
  ...
  faq: doc(
    ...
    [
      ["Is the price on the site the final price?",
        ["Yes, unless the listing page says otherwise. The price shown is the estimated final price to Bulgaria.",
      ...
      ["How long does delivery take?",
        ["Between 12 and 14 weeks from a confirmed order, depending on sailing schedules, port operations and customs.",
      ...
      ["Is registration included?",
        ["No. The price is the estimated final price to Bulgaria. Registration and local vehicle tax are yours to do.",
    ...
    [
      ["What the price on the site covers",
        ["The value of the car in Korea.",
         ...
         "Transport from the port to Bulgaria.",
      ...
      ["Paying",
        ["The deposit is paid by card through Stripe. The balance goes by bank transfer to the account of Auto&Bid LTD or to the account of our Canadian intermediary partner VIN TRADE LLC, whichever is stated on the invoice you receive.",
