  ...
  faq: doc(
    ...
    [
      ...
      ["Как задържам автомобил, който ми е харесал?",
        ["С депозит от 10% от цената на автомобила. Автомобилът спира да се предлага на други купувачи и депозитът се приспада от крайната цена.",
  ...
  fees: doc(
    ...
    [
      ...
      ["Депозит за резервация",
        ["10% от цената на автомобила. Приспада се от крайната цена.",
  ...
  faq: doc(
    ...
    [
      ...
      ["Cum rețin un automobil care mi-a plăcut?",
        ["Cu un depozit de 10% din prețul automobilului. Automobilul nu mai este oferit altor cumpărători, iar depozitul se scade din prețul final.",
  ...
  fees: doc(
    ...
    [
      ...
      ["Depozit de rezervare",
        ["10% din prețul automobilului. Se scade din prețul final.",
...
const EN = {
  faq: doc(
    ...
    [
      ...
      ["How do I hold a car I like?",
        ["With a deposit of 10% of the car's price. The car stops being offered to other buyers and the deposit comes off the final price.",
  ...
  fees: doc(
    ...
    [
      ...
      ["Reservation deposit",
        ["10% of the car's price. It comes off the final price.",
