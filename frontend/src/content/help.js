  ...
  faq: doc(
    ...
    [
      ...
      ["Как задържам автомобил, който ми е харесал?",
        ["С депозит от 10% от цената на автомобила. С него ние купуваме автомобила за вас, затова депозитът не се възстановява, ако се откажете. След като платите остатъка по банков път, ви връщаме депозита и задържаме 300 € комисиона. Ако ние не успеем да доставим автомобила, получавате всичко обратно.",
  ...
  fees: doc(
    ...
    [
      ...
      ["Депозит за резервация",
        ["10% от цената на автомобила. Не се възстановява при отказ — с него купуваме автомобила. Връща се след плащането на остатъка, като задържаме 300 € комисиона.",
  ...
  faq: doc(
    ...
    [
      ...
      ["Cum rețin un automobil care mi-a plăcut?",
        ["Cu un depozit de 10% din prețul automobilului. Cu el cumpărăm automobilul pentru tine, de aceea depozitul nu se restituie dacă te retragi. După ce plătești restul prin transfer bancar, îți returnăm depozitul și reținem 300 € comision. Dacă noi nu reușim să livrăm automobilul, primești totul înapoi.",
  ...
  fees: doc(
    ...
    [
      ...
      ["Depozit de rezervare",
        ["10% din prețul automobilului. Nu se restituie dacă te retragi — cu el cumpărăm automobilul. Se returnează după plata restului, mai puțin 300 € comision.",
...
const EN = {
  faq: doc(
    ...
    [
      ...
      ["How do I hold a car I like?",
        ["With a deposit of 10% of the car's price. We buy the car for you with it, so the deposit is not refundable if you change your mind. Once you pay the balance by bank transfer we return the deposit and keep €300 as our commission. If we cannot deliver the car, you get everything back.",
  ...
  fees: doc(
    ...
    [
      ...
      ["Reservation deposit",
        ["10% of the car's price. Not refundable if you withdraw — we buy the car with it. Returned once you pay the balance, less €300 commission.",
