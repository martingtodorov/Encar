  ...
  return (
    <div className="relative w-full sm:w-auto">
      ...
      <select
        ...
        aria-label={t("sortBy")}
        className="h-11 w-full min-w-[190px] appearance-none truncate rounded-[10px] border border-input bg-card pl-3 pr-9 text-sm text-foreground shadow-[var(--shadow-sm)] outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50 sm:w-auto"
      >
        {SORT_OPTIONS.map((o) => (
